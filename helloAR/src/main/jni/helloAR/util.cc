...
// Convenience function used in CreateProgram below.
        ...
        glm::mat4 GetRegionPoseFromFace(const ArSession *ar_session, const ArAugmentedFace *ar_face,
          ...
          ArAugmentedFace_getRegionPose(ar_session, ar_face, type, scopedArPose.GetArPose());
          ArPose_getMatrix(ar_session, scopedArPose.GetArPose(), glm::value_ptr(pos));
          return pos;
        }
    }  // namespace util
}  // namespace hello_ar
